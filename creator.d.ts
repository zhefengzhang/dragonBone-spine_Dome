...
declare module cc {	
	...
	*/
	...
	size: {
	get: function () {
	return cc.P(this.width, this.height);
	}
	}
	},
	...
	*/
	...
	@example 
	```js
	cc.PNeg(cc.P(10, 10));// Vec2 {x: -10, y: -10};
	``` 
	*/
	...
	@example 
	```js
	cc.PAdd(cc.P(1, 1), cc.P(2, 2));// Vec2 {x: 3, y: 3};
	``` 
	*/
	...
	@example 
	```js
	cc.PSub(cc.P(20, 20), cc.P(5, 5)); // Vec2 {x: 15, y: 15};
	``` 
	*/
	...
	@example 
	```js
	cc.PMult(cc.P(5, 5), 4); // Vec2 {x: 20, y: 20};
	``` 
	*/
	...
	@example 
	```js
	cc.PMidpoint(cc.P(10, 10), cc.P(5, 5)); // Vec2 {x: 7.5, y: 7.5};
	``` 
	*/
	...
	@example 
	```js
	cc.PDot(cc.P(20, 20), cc.P(5, 5)); // 200;
	``` 
	*/
	...
	@example 
	```js
	cc.PCross(cc.P(20, 20), cc.P(5, 5)); // 0;
	``` 
	*/
	...
	@example 
	```js
	cc.PPerp(cc.P(20, 20)); // Vec2 {x: -20, y: 20};
	``` 
	*/
	...
	@example 
	```js
	cc.PRPerp(cc.P(20, 20)); // Vec2 {x: 20, y: -20};
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	cc.PLength(cc.P(20, 20)); // 28.284271247461902;
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	cc.PNormalize(cc.P(20, 20)); // Vec2 {x: 0.7071067811865475, y: 0.7071067811865475};
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	cc.PToAngle(cc.P(20, 20)); // 0.7853981633974483;
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	var min_inclusive = cc.P(0, 0);
	var max_inclusive = cc.P(20, 20);
	var v1 = cc.PClamp(cc.P(20, 20), min_inclusive, max_inclusive); // Vec2 {x: 20, y: 20};
	var v2 = cc.PClamp(cc.P(0, 0), min_inclusive, max_inclusive);   // Vec2 {x: 0, y: 0};
	var v3 = cc.PClamp(cc.P(10, 10), min_inclusive, max_inclusive); // Vec2 {x: 10, y: 10};
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	cc.PLerp(cc.P(20, 20), cc.P(5, 5), 0.5); // Vec2 {x: 12.5, y: 12.5};
	``` 
	*/
	...
	*/
	...
	@example 
	```js
	cc.PCompMult(acc.P(20, 20), cc.P(5, 5)); // Vec2 {x: 100, y: 100};
	``` 
	*/
	...
	*/
	...
	Please use cc.P or cc.P instead, it will soon replace cc.Size.
	!#zh
	创建一个 cc.Size 对象的帮助函数。<br/>
	注意：可以使用 cc.P 或者是 cc.P 代替，它们将很快取代 cc.Size。
	...
	*/
	...
	export class TiledLayer extends _SGComponent {		
		...
		*/
		...
		@example 
		```js
		var pos = tiledLayer.getPositionAt(cc.P(0, 0));
		cc.log("Pos: " + pos);
		...
		*/
		...
		@example 
		```js
		tiledLayer.removeTileAt(cc.P(0, 0));
		...
		*/
		...
		2. 或 layer.removeTileAt(cc.P(x,y));
		@param pos or x
		@param y y
	...
	export class TiledObjectGroup extends _SGComponent {		
		...
		*/
		...
		@example 
		```js
		tMXObjectGroup.setPositionOffset(cc.P(5, 5));
		``` 
		*/
	...
	export class Node extends _BaseNode {		
		...
		*/
		...
		Usually we use cc.P(x, y) to compose cc.Vec2 object.<br/>
		and Passing two numbers (x, y) is more efficient than passing cc.Vec2 object.
		!#zh
		设置节点在父节点坐标系中的位置。<br/>
		可以通过两种方式设置坐标点：<br/>
		1. 传入 2 个数值 x 和 y。<br/>
		2. 传入 cc.P(x, y) 类型为 cc.Vec2 的对象。
		...
		*/
		...
		@example 
		```js
		var newVec2 = node.convertToNodeSpace(cc.P(100, 100));
		``` 
		*/
		...
		@example 
		```js
		var newVec2 = node.convertToWorldSpace(cc.P(100, 100));
		``` 
		*/
		...
		@example 
		```js
		var newVec2 = node.convertToNodeSpaceAR(cc.P(100, 100));
		``` 
		*/
		...
		@example 
		```js
		var newVec2 = node.convertToWorldSpaceAR(cc.P(100, 100));
		``` 
		*/
	...
	export class Rect extends ValueType {		
		...
		*/
		...
		@example 
		```js
		cc.Rect.fromMinMax(cc.P(10, 10), cc.P(20, 20)); // Rect {x: 10, y: 10, width: 10, height: 10};
		``` 
		*/
	...
	export class Vec2 extends ValueType {		
		...
		!#en
		Constructor
		see {{#crossLink "cc/vec2:method"}}cc.P{{/crossLink}} or {{#crossLink "cc/p:method"}}cc.P{{/crossLink}}
		!#zh
		构造函数，可查看 {{#crossLink "cc/vec2:method"}}cc.P{{/crossLink}} 或者 {{#crossLink "cc/p:method"}}cc.P{{/crossLink}}
		@param x x
		@param y y 
		*/
		...
		*/
		...
		```js
		var v = cc.P(10, 10);
		v.addSelf(cc.P(5, 5));// return Vec2 {x: 15, y: 15};
		``` 
		*/
		...
		```js
		var v = cc.P(10, 10);
		v.add(cc.P(5, 5));      // return Vec2 {x: 15, y: 15};
		var v1;
		v.add(cc.P(5, 5), v1);  // return Vec2 {x: 15, y: 15};
		``` 
		*/
		...
		```js
		var v = cc.P(10, 10);
		v.subSelf(cc.P(5, 5));// return Vec2 {x: 5, y: 5};
		``` 
		*/
		...
		```js
		var v = cc.P(10, 10);
		v.sub(cc.P(5, 5));      // return Vec2 {x: 5, y: 5};
		var v1;
		v.sub(cc.P(5, 5), v1);  // return Vec2 {x: 5, y: 5};
		``` 
		*/
		...
		*/
		...
		```js
		var v = cc.P(10, 10);
		v.scaleSelf(cc.P(5, 5));// return Vec2 {x: 50, y: 50};
		``` 
		*/
		...
		```js
		var v = cc.P(10, 10);
		v.scale(cc.P(5, 5));      // return Vec2 {x: 50, y: 50};
		var v1;
		v.scale(cc.P(5, 5), v1);  // return Vec2 {x: 50, y: 50};
		``` 
		*/
